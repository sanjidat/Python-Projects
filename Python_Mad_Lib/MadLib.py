...
from tkinter import*
# step Two: Create a Display Window 
root = Tk() # initialized tkinter which means window created.
root.geometry('300x300') # geometry is used to set the width and height of the window
root.title('DataFlair-Mad Libs Generator') # title is used to give the title of the window
Label(root, text= 'Mad Libs Generator \n Have Fun!' , font = 'arial 20 bold').pack() # 
Label(root, text = 'Click Any One :', font = 'arial 15 bold').place(x=40, y=80)
# Label() widget is used to display text that users can't able to modify
...
# Button() widget used to display buttons on out tkinter window
# root.mainloop() is used when we want to run our program